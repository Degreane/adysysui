...
class ProjectWindow(QtWidgets.QMainWindow):
    ...
    def initProject(self):
        qUrl=QtCore.QUrl('http://127.0.0.1:6910/project?path={0}'.format(self.ProjectPath))
    ...
    def _setupUI(self):
        ...
        self.WorkAreaMDI.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.WorkAreaMDI.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        ...
        # for now am going to set main browser that connects to path /project?path=/project/path
        ...
        self.ProjectWebBrowser = QtWebEngineWidgets.QWebEngineView(self.ProjectWebBrowserMDI)
        self.ProjectWebBrowser.setMinimumWidth(self.ProjectWebBrowserMDI.width())
        self.ProjectWebBrowser.setMinimumHeight(self.ProjectWebBrowserMDI.height())


        # Define Browser MdiChild Layout
        # Add ProjectBrowser to the Layout
        self.ProjectWebBrowserLayout=QtWidgets.QGridLayout(self.ProjectWebBrowserMDI)

        self.ProjectWebBrowserLayout.addWidget(self.ProjectWebBrowser,0,0,1,1)
